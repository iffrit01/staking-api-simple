...
now = '2023-04-09 00:00:00';
            ...
            for (let nft of mintsData) {
                ...
                if (Object.prototype.hasOwnProperty.call(config.hashlist, m)) {
                    tokens_to_claim += config.toDecimal(seconds_until_now * config.hashlist[m].yield_per_second);
                } else {
                    console.log("============== E R R O R : mint not in the list (unstakeMintsVerify.js) ====== ", m);
                }
