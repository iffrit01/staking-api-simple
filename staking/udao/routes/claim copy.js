...
now = '2023-04-09 00:00:00';
            if (
                ...
                for (let nft of dbNfts) {
                    ...
                    if (Object.prototype.hasOwnProperty.call(config.hashlist, nft.mint)) {
                        tokens_to_claim += config.toDecimal(seconds_until_now * config.hashlist[nft.mint].yield_per_second);
                    } else {
                        console.log("============== E R R O R : mint not in the list (claim.js) ====== ", m);
                    }
                    // ===================================================================================================================================
                }
            ...
            res.status(200).jsonp({
                ...
                // transaction: transaction// TODO remove
            });
