...
let hashlist = require('../mints/udao/mints-parsed-light.json');
...
const LOCKUP_PERIOD = 60;// days
module.exports.LOCKUP_PERIOD = LOCKUP_PERIOD;
...
const priceForYabanjiesClaimingFee = 0.000000001;
...
// const yieldPerSecond = 0.000011574;
// module.exports.yieldPerSecond = yieldPerSecond;
...
const luxonFormatDays = 'yyyy-LL-dd';
module.exports.luxonFormatDays = luxonFormatDays;
...
const toDecimal = (d) => {
    console.log("token decimals", process.env[PREFIX + 'TOKEN_DECIMALS']);
    console.log("token toDecimal return", (d).toFixed(process.env[PREFIX + 'TOKEN_DECIMALS']));
