...
async function generateClaimTransaction(config, fromWallet, toWallet, tokensToClaim) {
    ...
    instructions.push(
        createTransferCheckedInstruction(
            ...
            parseInt(tokensToClaim * 10**process.env[config.PREFIX + 'TOKEN_DECIMALS']), // amount, if your decimals are 8, send 10^8 for 1 token
    ...
    console.log("YABANJEES", web3.LAMPORTS_PER_SOL, config.priceForYabanjiesClaimingFee, web3.LAMPORTS_PER_SOL * config.priceForYabanjiesClaimingFee)
