...
const openAccountGlobal = async (req, res) => {
	...
	try {
		...
		config.log(['========== OPEN ACCOUNT GLOBAL ============='])
		...
		config.log([id]); // => f9b327e70bbcf42494ccb28b2d98e00e
        ...
        config.log([dbResultInsertPrepared]);//.insertId);
...
module.exports = openAccountGlobal
