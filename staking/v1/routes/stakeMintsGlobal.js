...
const getNftAccounts = require('../lib/get-nft-accounts');
...
const stakeMintsGlobal = async (req, res) => {
	...
	try {
		...
		let insertPrepared = [ id, receivedFromWalletPublicKey, JSON.stringify(mints), JSON.stringify(transaction), 'stake' ];
...
module.exports = stakeMintsGlobal
